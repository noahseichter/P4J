...
echo '<div id="homemmvideo">';

	echo '<div id="contentleftmm">';
	
		echo '<div class="postareamm">';
			...
			echo '<div id="loadingimage"><img src="' . get_template_directory_uri() . '/images/loading.gif" /></div>';
            	...
            	echo '<div id="videowrap">';
					...
					$recent = new WP_Query("cat=".get_theme_mod('mm-home-cat')."&showposts=1"); 
						...
						echo '<div class="videolist">';
							echo '<ul>';
								echo '<div class="multimediaboxline"></div>';
									...
									$catvariable = get_theme_mod('mm-home-cat'); 
									$limitvariable = get_theme_mod('mm-home-count');
									$querystr = "
