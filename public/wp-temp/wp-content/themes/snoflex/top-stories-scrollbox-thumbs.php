...
<?php $loopcounter=0; $featurecount = get_theme_mod('featured-count'); if ($featurecount == '') { $featurecount = 4; } 
					...
					echo '<div id="tsthumbs">';
						echo '<div class="flex-container">';
							echo '<div class="tsthumbstop">';
							...
							echo '<div class="tsthumbsbottom">';
							echo '<div id="tsslideshow" class="flexslider slideroverlay">';
								echo '<ul class="slides">';
									rewind_posts(); if (have_posts()) : while (have_posts()) : the_post();
										...
										echo '<li class="storyslide">'; ?>
											...
											<a href="<?php if (($customlink) && (get_theme_mod('top-stories-links')=="Yes")) { echo $customlink; } else { the_permalink(); } ?>"><img src="<?php echo $image[0]; ?>" class="catboxphoto" alt="<?php the_title(); ?>" /></a> 
